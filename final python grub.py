...
class RestaurantManagementSystem:
    def __init__(self, root):
        ...
        self.root.configure(bg="#f1b2c7")
        self.custom_font = tk.font.Font(family="Helvetica", size=12)
        self.background_image = tk.PhotoImage(file=r"C:\Users\abgan\Downloads\Python GrubToGo\valley.gif")
        ...
        ksukhampreet@oksbi
        Use the above paytm id""" # Replace with the payment information
    ...
    def generate_qr_code(self, data):
        ...
        qr.add_data(data)
        qr.make(fit=True)
        qr_img = qr.make_image(fill_color="black", back_color="white")    #       Convert the QR code image to Tkinter PhotoImage
